...
int ZSharpIR::distance() {
    ...
    // Read this tutorial to manually calibrate your SharpIR sensor https://diyprojects.io/proximity-sensor-a02yk0-test-calibration-sharp-gp2y0a02yk0f-asian-clone/
    // Lisez ce tutoriel pour étalonner manuellement votre capteur SharpIR https://projetsdiy.fr/test-et-etalonnage-du-capteur-de-proximite-a02yk0-clone-asiatique-du-sharp-gp2y0a02yk0f/
    if (_model==999){
